    ...
    <main className="min-h-screen overflow-hidden bg-white">
      <header className="site-container relative z-30 flex h-20 items-center justify-between">
        ...
        >
          ...
          <span className="text-[19px] font-extrabold tracking-[-0.045em] text-strong">
            엔카북카
          </span>
        </a>
        ...
        <a className="login-button" href={session ? "/profile" : "/login"}>
        ...
        <div className="site-container relative z-10 grid items-center gap-14 py-20 md:min-h-[690px] md:grid-cols-[1.08fr_0.92fr] md:py-24">
          <div className="max-w-[720px]">
            ...
            <div className="mt-10 flex flex-col gap-3 sm:flex-row">
              ...
              <Link className="secondary-button" href="/books/new">
                <Plus size={19} aria-hidden="true" />책 등록하기
              </Link>
            </div>
          </div>
          ...
          >
            ...
            <div className="floating-sparkle sparkle-one" aria-hidden="true">
              ✦
            </div>
            <div className="floating-sparkle sparkle-two" aria-hidden="true">
              ✦
            </div>
      ...
      <section id="share" className="site-container py-24 md:py-32">
        <div className="share-card">
          <div className="relative z-10 max-w-[560px]">
            <span className="share-label">내 책장 속 좋은 책 한 권</span>
            <h2>동료에게 건네는 가장 쉬운 추천</h2>
            <p>
              책 제목과 저자만 입력하면 등록할 수 있어요. 표지와 상세 정보는
              엔카북카가 채워드릴게요.
            </p>
            <Link href="/books/new">
              첫 책 등록하기
          ...
          <div className="share-books" aria-hidden="true">
      ...
      <footer className="border-t border-[#f0f2f4] bg-[#f9fafb]">
        <div className="site-container flex flex-col gap-4 py-10 text-sm text-muted sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-2 font-bold text-body">
            <BookOpen size={17} aria-hidden="true" /> 엔카북카
          </div>
